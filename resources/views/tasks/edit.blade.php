...
<div class="max-w-xl mx-auto mt-10 px-4">
    ...
    <form action="{{ route('tasks.update',$task->id) }}" method="POST" class="bg-white shadow-xl rounded-2xl p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <textarea name="description"
                class="w-full p-3 border rounded-md focus:ring-2 focus:ring-pink-300">{{ $task->description }}</textarea>
        </div>
